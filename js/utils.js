...
export function formatarNumeroZero(numero) { return numero.toString().padStart(2, '0'); }
...
export function verificarLoginEAcao(acao, usuarioAtual) {
    if (!usuarioAtual) { mostrarModalLogin(); return false; }
...
export function getModoTexto(modo) { 
    const modos = { 'ia_especialista': '🎓 IA Especialista', 'probabilistico': '📊 Probabilístico', 'aleatorio_inteligente': '🎲 Aleatório Inteligente', 'aleatorio_puro': '🎯 Aleatório Puro (RNG)' }; 
